...
const Controls = ({ isPlaying, repeat, setRepeat, shuffle, setShuffle, currentEpisodes, handlePlayPause, handlePrevEpisode, handleNextEpisode }) => (
  <div className="flex items-center justify-around md:w-36 lg:w-52 2xl:w-80">
    ...
    {currentEpisodes?.length && <MdSkipPrevious size={30} color="#FFF" className="cursor-pointer" onClick={handlePrevEpisode} />}
    {isPlaying ? (
    ...
    {currentEpisodes?.length && <MdSkipNext size={30} color="#FFF" className="cursor-pointer" onClick={handleNextEpisode} />}
